  ...
  * */
  ...
  return (
      <View style={theme.createPage}>
          <View>
            <TouchableOpacity style={[theme.generalBtn, theme.createBtn]} onPress={createEventHandler}>
                <Text style={theme.loginButtonText}>New Event</Text>
            </TouchableOpacity>
            <TouchableOpacity style={[theme.generalBtn, theme.createBtn]} onPress={createPostHandler}>
