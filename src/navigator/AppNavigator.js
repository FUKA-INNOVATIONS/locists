...
const SinglePostScreen = ({ navigation }) => (
  <View>
    <Text>Single post view</Text>
  </View>
)
const SingleEventScreen = () => (
  <View>
    <Text>Single event view</Text>
  </View>
)
const EventListScreen = () => (
  <View>
    <Text>Event list view</Text>
  </View>
)
const CreateEventScreen = () => (
  <View>
    <Text>Create event view</Text>
  </View>
)
const CreatePostScreen = () => (
  <View>
    <Text>Create post view</Text>
  </View>
)
    ...
    <AuthStorageContext.Consumer>
      {(value) => {
        ...
        return (
          <HomeStack.Navigator>
            <HomeStack.Screen
              userStatus={value.isLogged}
              name={'Home'}
              component={HomeScreen}
            />
            <HomeStack.Screen
              name={'SinglePostHomeStack'}
              component={SinglePostScreen}
            />
            <HomeStack.Screen
              name={'SingleEvenHomeStack'}
...
const EventStackScreen = () => {
  return (
    <EventStack.Navigator>
      ...
      <EventStack.Screen name={'SingleEvent'} component={SingleEventScreen} />
    </EventStack.Navigator>
  )
}
